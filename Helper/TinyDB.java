...
public class TinyDB {
    ...
    public ArrayList<Drinks> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Drinks> playerList =  new ArrayList<Drinks>();

        for(String jObjString : objStrings){
            Drinks player  = gson.fromJson(jObjString,  Drinks.class);
    ...
    public void putListObject(String key, ArrayList<Drinks> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Drinks player: playerList){
